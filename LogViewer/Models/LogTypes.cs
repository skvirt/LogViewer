...
namespace LogViewer.Models
{
    public static class LogTypes
    {
        public enum LogType
        {
            ...
            [Display(Name = "Пополнение денег")] GET_MONEY, [Display(Name = "Вход")] LOGIN, [Display(Name = "Выход")] LOGOUT,
            [Display(Name = "Реферал приглашён")] REFERRAL_INVITE, [Display(Name = "Создана реф. ссылка")] REFERRAL_GENERATE_NEW_LINK,
            [Display(Name = "Блокировка")] BAN, [Display(Name = "Разблокировка")] UNBAN, [Display(Name = "Регистрация")] REGISTER_USER,
            [Display(Name = "about us ред.")] EDIT_ABOUT_US, [Display(Name = "Изменение пользователя")] EDIT_USER,
            [Display(Name = "Изменение руководства")] EDIT_HEADS, [Display(Name = "Снятие руководства")] REMOVE_HEADS,
            [Display(Name = "Изменение рефералки")] EDIT_REFERRAL, [Display(Name = "Удаление рефералки")] DELETE_REFERRAL,
            [Display(Name = "Добавление статьи")] ADD_ARTICLE, [Display(Name = "Изменение статьи")] CHANGE_ARTICLE,
            [Display(Name = "Удаление статьи")] DELETE_ARTICLE
        }
